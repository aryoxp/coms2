...
<fieldset>
    ...
    ?>
        ...
        <tr id="module-<?php echo $mod->id; ?>" 
            ...
            <td><?php echo $mod->version; ?>. <span class="label label-info" title="Build Number"><?php echo $mod->version_index; ?></span></td>
            <td style="width: 80px;"><?php echo in_array($mod->id, $active_modules) ? 
            	'<div class="label label-success" id="status-'.$mod->id.'">Active</a>' : 
            	'<div class="label label-default" id="status-'.$mod->id.'">Inactive</a>'; ?></td>
            <td>
            
				<ul class="nav nav-pills" style="margin:0;">
				<li class="dropdown">
				  <a class="dropdown-toggle" id="drop4" role="button" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-link"></span></a>
				  <ul id="menu1" class="dropdown-menu" role="menu" aria-labelledby="drop4">
				    <li>
				    <a class="btn-toggle-status" data-loading-text="Toggling..." href="#"><i class="glyphicon glyphicon-refresh"></i> Toggle Status</a>	
				    </li>
				    <li class="divider"></li>
				    <li>
					<a class="btn-uninstall" href="#">
					  <i class="glyphicon glyphicon-remove"></i> Uninstall
					</a>
				    </li>
				  </ul>
				</li>
